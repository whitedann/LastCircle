...
public class GameState extends State{
    ...
    public GameState(Handler handler){
        ...
        File resources = file.getParentFile().getParentFile().getParentFile();
        this.world = new World(handler,resources + "\\target\\classes\\world1.txt", resources + "\\target\\classes\\SpawnPattern1.txt");
